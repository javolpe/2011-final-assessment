...
RSpec.describe 'Doctor Index Page' do 
  ...
  it "shows all the doctors and their attributes" do 
    within("#doctor-#{@doc1.id}") do 
      ...
      expect(page).to have_content("University: #{@doc1.universtiy}")
    end
    ...
    within("#doctor-#{@doc2.id}") do 
      ...
      expect(page).to have_content("University: #{@doc2.universtiy}")
    end
    ...
    within("#doctor-#{@doc3.id}") do 
      ...
      expect(page).to have_content("University: #{@doc3.universtiy}")
    end
  end
end